...
public class NSFEOActivity extends ActionBarActivity {
	...
	private final static String LOGIN_TRANSACTION_TAG = "NSFEOActivity.this::add R.id.container, LoginFragment";
	...
	@SafeVarargs
	private final void initDatabase(final Class<? extends Model> ... models) {
